...
local Config = {
    ...
    PlatoSecret     = "0f7ad3a8-6da1-4ee5-8292-a09c82b37db2", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "30138", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/OYB0/OYB0/refs/heads/main/Roblox/Executor/KeySystem/KeySystemUi.lua", -- The raw URL of your main script
    ...
    HubName         = "Boxwarp Hub", -- The main title shown at the top of the GUI
    HubDescription  = "like and follow" -- The text shown below the title
}
